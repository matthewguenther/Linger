...
| **M12** | Voice rooms | Four people, four networks, one hour, no drops | 1–2 weeks — **the whole audio path landed 2026-09-01 and 2026-09-04 (T-1401, T-1402): frames, peer connections, ICE, microphone → Opus → RTP → speakers. Proven on one machine only; no STUN or TURN yet (T-1403), and no surface to press (T-1404)** |
