...
export default function StatusEditor({
  ...
  return (
    ...
    >
      ...
      {/* SPEC §4.6 allows one image on a status. It needs somewhere to put the
          file, and that is the media store M6 builds (T-601). Saying so is
          better than an upload button that cannot work. */}
