  ...
  return (
    <div className="person-status">
      ...
      {/*
        ...
        there is no media store until M6 builds the upload pipeline (T-601).
        The field is carried through every save so nothing is lost in the
        meantime; the editor says as much.
      */}
    </div>
  );
}
