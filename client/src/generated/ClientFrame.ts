 ...
 */
s: number | null, } } | { "op": "presence.update", "d": { state: PresenceState, away_message: string | null, } } | { "op": "room.focus", "d": { room_id: RoomId | null, } } | { "op": "typing.start", "d": { room_id: RoomId, } } | { "op": "voice.join", "d": { room_id: RoomId, } } | { "op": "voice.leave" } | { "op": "voice.signal", "d": { 
/**
